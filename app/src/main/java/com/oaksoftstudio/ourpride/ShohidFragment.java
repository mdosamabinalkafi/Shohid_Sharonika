...
public class ShohidFragment extends Fragment {
  ...
  MyAdapter adapter = new MyAdapter(arrayList);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View shohidView = inflater.inflate(R.layout.fragment_shohid, container, false);





        gridView = shohidView.findViewById(R.id.gridView);
        ShohidList();
        gridView.setAdapter(adapter);


        // for search view
        searchView = shohidView.findViewById(R.id.searchView);
...
*/
    ...
    private void fileList(String newText) {
        ...
        if (arrayList1.isEmpty()) {
            Toast.makeText(getActivity(), "খুঁজে পাওয়া যায় নি", Toast.LENGTH_SHORT).show();
        } else {
