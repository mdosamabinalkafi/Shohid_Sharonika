...
public class EnemyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View enemyView = inflater.inflate(R.layout.fragment_enemy, container, false);



        gridView3 = enemyView.findViewById(R.id.gridView3);
        ...
        // for search view
        searchView = enemyView.findViewById(R.id.searchView);
